...
//  * @return {Object} { code, success, data }
//  */
//   const getSubAccountSpotApiListResult = await API.rest.User.Account.getSubAccountSpotApiList({apiKey:'646ae0364acb1200019056e8',subName:'AAAAAAAAAA0008'});
//   console.log(getSubAccountSpotApiListResult ,"getSubAccountSpotApiListResult---");

//   /**
//  * @name createSpotAPIsForSubAccount TODO Contain invalid or sensitive information
...
//   const createSpotAPIsForSubAccountResult = await API.rest.User.Account.createSpotAPIsForSubAccount({subName:'AAAAAAAAAA0009',passphrase:'passphrase',remark:'remarks',permission:'General',ipWhitelist:'',expire:'30'});
//   console.log(createSpotAPIsForSubAccountResult ,"createSpotAPIsForSubAccountResult---");

// /**
//  * @name updateSubAccountSpotApis TODO Contain invalid or sensitive information
...
//  * @return {Object} { code, success, data }
//  */
//   const updateSubAccountSpotApisResult = await API.rest.User.Account.updateSubAccountSpotApis({subName:'AAAAAAAAAA0009',apiKey:"646ae0364acb1200019056e8",passphrase:'passphrase',permission:'Trade',ipWhitelist:'10.85.106.8',expire:'90'});
//   console.log(updateSubAccountSpotApisResult ,"updateSubAccountSpotApisResult---");

//   /**
//  * @name deleteSubAccountSpotApis TODO Contain invalid or sensitive information
...
//  * @return {Object} { code, success, data }
//  */
//   const deleteSubAccountSpotApisResult = await API.rest.User.Account.deleteSubAccountSpotApis({apiKey:"646ae0364acb1200019056e8",passphrase:"passphrase",subName:"AAAAAAAAAA0009"});
...
// /**
//  * @name transferToHFAccount TODO Bad Request
...
// const transferToHFAccountResult = await API.rest.User.Account.transferToHFAccount({clientOid:"178511867",type:"MARGIN",currency:"USDT",from:"margin",to:"pool",amount:'amount'});
...
//  /////////////////////high-frequency api//////////////////////////////////////////////////////
// /**
//  * @name innerTransfer TODO Bad Request
...
//  * @return {Object} { code, success, data }
//  */
// const innerTransferResult = await API.rest.User.Account.innerTransfer("178511867",'USDT','trade','pool','amount','BTC-USDT','BTC-USDT');
...
// /**
//  * @name modifyOrder TODO request timeout
...
// /**
//  * @name cancelSpecifiedNumberOfOrdersByOrderId TODO request timeout
