...
const transferToHFAccountResult = await API.rest.User.Account.transferToHFAccount({clientOid:"1234567",type:"MARGIN",currency:"USDT",from:"margin",to:"pool",amount:'amount'});
 ...
 * @return {Object} { code, success, data }
 */
const innerTransferResult = await API.rest.User.Account.innerTransfer("1234567",'USDT','trade','pool','amount');
